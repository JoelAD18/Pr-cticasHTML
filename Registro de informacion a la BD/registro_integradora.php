                ...
                <div class="container-fluid">  <!-- Inicio del div contenedor principal-->
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent"> <!-- Contenedor para generar efecto menu -->
                        <u1 class="navbar-nav me-auto mb-2 mb-lg-0">
                            ...
                            <li class="nav-item"><a class="nav-link" href="registro.html">Alta</a></li>
                            <li class="nav-item"><a class="nav-link" href="catalogo.html">Catalago</a></li>
                            <li class="nav-item"><a class="nav-link" href="login.html">Cerrar Sesion</a></li>        
                        </u1>
        ...
        <section class="container m-5 bg-light">
            <div class="row">
                <div class="col-lg-8"> 
                    ...
                    <form method="$_GET" action="recibir_integradora.php">
                        <div class="row mb-3">
                            <label class="col-sm-10">Codigo de calzado</label>
                            <div class="col-sm-10">
                                <input type="text" name="codigo_calzado" class="form-control" placeholder="Introduce el codigo del calzado" require>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="descripcion" class="form-control" placeholder="Escribe la descripcion del calzado" require>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="talla" class="form-control" placeholder="Introduce la talla del calzado" require>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="precio" class="form-control" placeholder="Introduce el precio del calzado" require>
                            </div>
                        </div>
